...
- `base_salary` (numeric, optional) - الراتب الثابت (يمكن تحديده أو تركه ليأخذ من آخر راتب)
...
- **الراتب الثابت**: يتم تحديده بالترتيب التالي:
  1. من الـ request إذا تم إرساله (`base_salary`)
  2. من آخر راتب للمندوب إذا كان موجود
  3. 1,000,000 دينار عراقي (افتراضي)
...
**مثال مع تحديد الراتب:**
```json
POST /api/representatives/1/salaries/calculate
{
  "month": "2026-01",
  "base_salary": 1200000
}
...
**مثال بدون تحديد (يستخدم آخر راتب أو الافتراضي):**
```json
POST /api/representatives/1/salaries/calculate
{
  "month": "2026-01"
...
- **الراتب الثابت**: يمكن تحديده يدوياً عند إنشاء أو حساب الراتب، وإذا لم يُحدد:
  - يتم استخدام آخر راتب ثابت للمندوب (إذا كان موجود)
  - أو 1,000,000 دينار عراقي (افتراضي)
